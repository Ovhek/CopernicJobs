...
public class ConfiguracioWeb implements WebMvcConfigurer {
    ...
    */
    @Override
    public void addViewControllers(ViewControllerRegistry registre) { //Mostrem la pàgina incial que reanomenen com a index, quan encara no ens hem autenticat
        registre.addViewController("/alumne/inici"); //Mostrem la pàgina login quan l'usuari no ha pogut autenticar-se
