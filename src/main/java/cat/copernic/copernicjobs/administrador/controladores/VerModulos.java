...
public class VerModulos {
    ...
    public String guardar(@RequestParam(name="modulos", required = false) List<String> checkModulos, @RequestParam(name="visible", required = false)List<String> checkVisibles){
